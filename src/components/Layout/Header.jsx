    ...
    <AppBar position="static" sx={{ backgroundColor: 'purple' }}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          {/* Menu de navegación para dispositivos pequeños */}
          ...
          {/* Logo y navegación para dispositivos grandes */}
              ...
              {authStatus
                ? settingsAuth.map((setting) => (
                    <MenuItem
                      key={setting}
                      onClick={
                        setting === 'Cerrar Sesión' ? handleLogout : handleCloseUserMenu
                      }
                    >
                ...
                : settingsNoAuth.map((setting) => (
                    <MenuItem
                      ...
                      component={Link}
                      to={setting === 'Iniciar Sesión' ? '/iniciar-sesion' : '/registro'}
                    >
                      <Typography textAlign="center">{setting}</Typography>
                    </MenuItem>
                  ))}
